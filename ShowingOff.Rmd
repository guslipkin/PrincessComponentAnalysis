---
title: "A quick and easy way to show off the fun stuff"
output:
...
animated <- rbindlist(list(
  readSRT("Aladdin.srt")[, movie := "Aladdin"],
  readSRT("Beauty and the Beast.srt")[, movie := "Beauty"],
  readSRT("Brave.srt")[, movie := "Brave"],
  readSRT("Cinderella.srt")[, movie := "Cinderella"],
  readSRT("The Princess and the Frog.srt")[, movie := "Frog"],
  readSRT("The Little Mermaid.srt")[, movie := "Mermaid"],
  readSRT("Moana.srt")[, movie := "Moana"],
  readSRT("Mulan.srt")[, movie := "Mulan"],
  readSRT("Pocahontas.srt")[, movie := "Pocahontas"],
  readSRT("Sleeping Beauty.srt")[, movie := "Sleeping"],
  readSRT("Snow White and The Seven Dwarfs.srt")[, movie := "Snow"],
  readSRT("Tangled.srt")[, movie := "Tangled"]))
