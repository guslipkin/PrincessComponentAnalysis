...
wordcloud
htmlwidgets::saveWidget(wordcloud, "wordcloud.html", selfcontained = FALSE)
webshot::webshot("wordcloud.html", "wordcloud.png", delay = 10)
```
...
wordcloud
htmlwidgets::saveWidget(wordcloud, "wordcloudTrigram.html", selfcontained = FALSE)
webshot::webshot("wordcloudTrigram.html", "wordcloudTrigram.png", delay = 10)
```
